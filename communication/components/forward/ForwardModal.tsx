...
export function ForwardModal({
  ...
  return (
    <div className="fixed inset-0 z-[120] bg-slate-950/40 backdrop-blur-[2px]">
      <div className="flex h-full w-full items-center justify-center p-4">
        <div className="flex max-h-[min(640px,88dvh)] w-full max-w-[640px] flex-col overflow-hidden rounded-xl border border-slate-200/90 bg-white shadow-[0_24px_60px_rgba(15,23,42,0.14)]">
