  ...
  return (
    <section className="space-y-6">
      <div className="rounded-xl border border-slate-200 bg-white p-5 md:p-6">
        <h2 className="text-2xl text-slate-900 leading-tight font-semibold tracking-tight">Request help</h2>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          <p className="text-xs font-semibold uppercase tracking-wide text-slate-400">Late requests today</p>
          <p className="mt-2 text-base font-semibold text-slate-950">{stats.requested} pending</p>
        </div>
        <div className="rounded-xl border border-slate-200 bg-white p-5">
          <p className="text-xs font-semibold uppercase tracking-wide text-slate-400">Approved / rejected</p>
          <p className="mt-2 text-base font-semibold text-slate-950">
      ...
      <div className="rounded-xl border-2 border-brand-red/30 bg-white p-6 shadow-sm">
        ...
        <h3 className="text-2xl font-semibold text-slate-950 tracking-tight">Request attendance correction</h3>
        ...
        <div className="mt-6 space-y-2 border-t border-slate-100 pt-4">
          <h4 className="text-xs font-semibold uppercase tracking-wide text-slate-400">My correction requests</h4>
      ...
      <div className="rounded-xl border border-slate-800/80 bg-slate-900 p-6 text-white">
        ...
        <h3 className="text-2xl font-semibold text-white tracking-tight">Request late login approval</h3>
        <p className="mt-2 text-sm leading-6 text-slate-300">
          After {lateLoginPolicy?.cutoffTimeLabel || '1:05 PM'}, if login is blocked, send approval here.
        </p>

        <div className="mt-6 rounded-xl border border-white/10 bg-white/5 px-4 py-4 text-sm text-slate-300">
        ...
        <label className="mt-5 block">
          ...
          <textarea
            ...
            className="w-full rounded-lg border border-white/12 bg-white/10 px-4 py-3 text-sm text-white outline-none placeholder:text-slate-400"
          />
        </label>

        {requestMessage ? (
          <p className="mt-4 rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-slate-200">
            {requestMessage}
          </p>
        ) : null}
        ...
        <button
          ...
          className={`mt-4 inline-flex items-center justify-center gap-2 rounded-lg px-4 py-3 text-sm font-semibold transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 ${
            !canRequestApproval || requestLoading
              ? 'cursor-not-allowed bg-white/10 text-slate-400'
              : 'bg-white text-slate-950 shadow-sm hover:-translate-y-0.5 hover:bg-slate-100 hover:shadow-sm active:translate-y-0'
          }`}
        >
          {requestLoading ? (
            <Loader2 size={15} className="animate-spin" aria-hidden />
      ...
      <div className="overflow-hidden rounded-xl border border-slate-200 bg-white">
        <div className="border-b border-slate-100 px-6 py-5">
          <h3 className="text-xl font-semibold text-slate-950 tracking-tight">Today late-login history</h3>
        </div>
