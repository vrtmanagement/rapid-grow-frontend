...
function getAutomatedMailSeriesKey(task?: SpacesTask) {
  if (!task) return '';
...
function taskHasAutomatedMailState(task?: SpacesTask) {
          ...
          <tbody>
            {spacesLoading ? (
              ...
              paginatedTasks.map((t: any) => {
                ...
                const showMailActive = hasAutomatedMail && isMailIndicatorTask;
                const showMailStopped = hasStoppedMail && isMailIndicatorTask;
                ...
                return (
                  <tr
                    ...
                    className={`${getTaskRowClasses(t)} cursor-pointer transition-colors ${
                      showMailActive ? 'bg-emerald-50' : showMailStopped ? 'bg-rose-50' : ''
                    } ${
                      isSelected
